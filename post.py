...
TMDB_API_KEY = "252ce4f9b28effb7b4e67d41bfedc51d"  # 🔐 Replace with your TMDB API key
...
# 🔎 Clean Movie Name From Messy Filename
def clean_movie_query(raw_text):
    ...
    # Capitalize words for TMDB match
    return ' '.join(word.capitalize() for word in text.split())


# 🔍 Extract Year From Query (2024, 2023, etc.)
...
# 🎞️ Get Backdrop Posters from TMDB
...
# 🎥 Get OTT Posters from JustWatch
